...
import { reportProfile } from "@/services/bsky.service";
...
const REPORT_REASONS: ReportReason[] = [
  {
    ...
    title: "Spam",
    description: "Spam account or bot",
  },
  {
...
export function ReportProfileModal({ did, handle, displayName }: ReportProfileModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const success = await reportProfile(agent, {
      ...
      if (success) {
        Alert.alert(
          "Report Submitted",
          "Thank you for your report. Our moderation team will review this profile within 24 hours.",
          [
            {
              text: "OK",
              onPress: () => closeModal(),
