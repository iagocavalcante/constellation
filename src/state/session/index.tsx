...
const AgentContext = React.createContext<AtpAgent | null>(null);
...
export function Provider({ children }: React.PropsWithChildren<{}>) {
  ...
  const createAccount = React.useCallback<SessionApiContext["createAccount"]>(
    async (params) => {
      ...
      logEvent("account:create:begin", {}, client as StatsigClientExpo);
      ...
      logEvent("account:create:success", {}, client as StatsigClientExpo);
      addSessionDebugLog({
        type: "method:end",
